...
async def receive_events_from_iothub(iothub_conn_str, consumer_group="$Default", callback=None):
    ...
    consumer_client = EventHubConsumerClient.from_connection_string(eventhub_conn_str, consumer_group)
    ...
    async def on_event_batch(partition_context, events):
        for event in events:
            ...
            formatted_message = {
                'DeviceId': device_id,
                'MessageDate': event.enqueued_time.isoformat(),
                'IotData': message_data
            }
        ...
        # Update the checkpoint after processing
